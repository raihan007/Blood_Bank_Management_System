...
{
    public partial class DonorEntryForm : Form
    {
        ...
        private Donor donor;
        private int donorId;
        private DonorsListForm donorForm;
        private DateTime lastDonate;

        public DonorEntryForm(DonorsListForm donorForm, string _action, int donorId, int _branchId)
        {
